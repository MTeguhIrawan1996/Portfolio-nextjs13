...
const Card = ({ title, imgUrl, tags, stacks }: IProps) => {
  return (
    <motion.div
      ...
      className='relative h-96 w-full overflow-hidden rounded-xl bg-gradient-to-r from-primary-600 to-primary-800 p-8'
    >
      <div className='relative z-10 flex h-full flex-col items-start justify-end gap-1 text-white'>
        ...
        <motion.span
          ...
          className='block origin-top-left font-mono text-2xl font-black leading-[1.1] md:text-4xl'
        >
          {title}
        </motion.span>
